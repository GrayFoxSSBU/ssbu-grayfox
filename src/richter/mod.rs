...
unsafe fn richter_specialn_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn richter_catch_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn richter_throwhi_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn richter_throwlw_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn richter_attackairf_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn richter_attackairfhi_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn richter_attackairflw_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn richter_attackairb_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn richter_attackairbhi_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn richter_attackairblw_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn richter_attackairhi_smash_script(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    ...
    smashline::install_acmd_scripts!(
        richter_specialn_smash_script,
        richter_catch_smash_script,
        richter_throwhi_smash_script,
        richter_throwlw_smash_script,
        richter_attackairf_smash_script,
        richter_attackairfhi_smash_script,
        richter_attackairflw_smash_script,
        richter_attackairb_smash_script,
        richter_attackairbhi_smash_script,
        richter_attackairblw_smash_script,
        richter_attackairhi_smash_script
    );
}
