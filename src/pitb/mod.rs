...
unsafe fn pitb_attacks3_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn pitb_attackairn_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn pitb_attackairf_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn pitb_attackairlw_smash_script(fighter: &mut L2CAgentBase) {
...
unsafe fn pitb_specialhi_smash_script(fighter: &mut L2CAgentBase) {
...
pub fn install() {
    ...
    smashline::install_acmd_scripts!(
        pitb_attacks3_smash_script,
        pitb_attackairn_smash_script,
        pitb_attackairf_smash_script,
        pitb_attackairlw_smash_script,
        pitb_specialhi_smash_script
